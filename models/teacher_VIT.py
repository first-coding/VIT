...
from Config.config import config,init_vit_weights
...
class PatchEmbed(nn.Module):
    def __init__(self, img_size=config['img_size'], patch_size=config['patch_size'], in_c=config['in_c'], embed_dim=config['embed_dim']):
...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=config['img_size'], patch_size=config['patch_size'], in_c=config['in_c'],
